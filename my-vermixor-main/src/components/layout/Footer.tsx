      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <Logo className="text-secondary-foreground mb-4" size="md" />
            <p className="text-secondary-foreground/80 mb-6 max-w-md">
              We craft websites, apps, and AI solutions that move businesses forward. 
              Design-forward experiences that deliver measurable growth.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-secondary-foreground/10 border border-secondary-foreground/20 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary"
                />
        ...
        {/* Bottom section */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-secondary-foreground/20">
          <div className="flex flex-col md:flex-row items-center gap-4 text-sm text-secondary-foreground/80">
            <p>&copy; 2024 Vermixor. All rights reserved.</p>
